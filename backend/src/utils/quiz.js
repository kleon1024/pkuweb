...
const zhiyuanQuizItems = [
  {
    ...
    description: '根据你在上一环节中填写的内容，你的一本志愿如下', // 志愿表上方的描述
    questions: [
      // 该问题中的子问题
      {
        propositionDescription:
          '假设你没有填写提前批次的志愿，请对下列情况发生的可能性（概率）做一个估计', // 命题描述
        proposition: '你最终进入X1读书' // 命题本身
      },
      {
        propositionDescription:
          '假设你没有填写提前批次的志愿，请对下列情况发生的可能性（概率）做一个估计',
        proposition: '你最终进入前两所志愿院校（即X1，X2）中的某一所读书',
        hint:
  ...
  },
  {
    ...
    descriptionHighlight:
      '假设你改变了志愿表中院校排列的顺序：你把X1和X2对应的院校的位置调换了一下。',
    description: '在调换之后，你的志愿表如下',
    questions: [
      {
        propositionDescription:
          '假设你没有填写提前批次的志愿，请对下列情况发生的可能性（概率）做一个估计',
        proposition: '你最终进入X2读书'
      },
      {
        propositionDescription:
          '假设你没有填写提前批次的志愿，请对下列情况发生的可能性（概率）做一个估计',
        proposition: '你最终进入前两所志愿院校（即X2，X1）中的某一所读书',
        hint:
  ...
  },
  {
    ...
    descriptionHighlight: '假设你把志愿表中几所院校位置调换了一下。',
    description: '调换之后，你的志愿表如下',
    questions: [
      {
        propositionDescription:
          '假设你没有填写提前批次的志愿，请对下列情况发生的可能性（概率）做一个估计',
        proposition: '你最终进入X4读书'
      },
      {
        propositionDescription:
          '假设你没有填写提前批次的志愿，请对下列情况发生的可能性（概率）做一个估计',
        proposition: '你最终进入前两所志愿院校（即X4，X1）中的某一所读书',
        hint:
    ...
    questions: [
      {
        propositionDescription:
          '假设你没有填写提前批次的志愿，请对下列情况发生的可能性（概率）做一个估计',
        proposition: '你最终进入X1读书'
      },
      {
        propositionDescription:
          '假设你没有填写提前批次的志愿，请对下列情况发生的可能性（概率）做一个估计',
        proposition: '你最终进入前两所志愿院校（即X1，X4）中的某一所读书',
        hint:
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        propositionDescription:
          '假设你没有填写提前批次的志愿，请对下列情况发生的可能性（概率）做一个估计',
        proposition: '你最终进入后两所志愿院校（即X1，X2）中的某一所读书',
        hint:
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        propositionDescription:
          '假设你没有填写提前批次的志愿，请对下列情况发生的可能性（概率）做一个估计',
        proposition: '你最终进入后两所志愿院校（即X2，X1）中的某一所读书',
        hint:
          '提示：本题的情况（就读于X2或X1）包含了前一道问题中的情况（就读于X2），所以和前一道题相比，本题的可能性应该会更大或者相等'
      }
    ]
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        propositionDescription:
          '假设你没有填写提前批次的志愿，请对下列情况发生的可能性（概率）做一个估计',
        proposition: '你最终进入前两所志愿院校（即X1，X3）中的某一所读书',
        hint:
    ...
    questions: [
      {
        propositionDescription:
          '假设你没有填写提前批次的志愿，请对下列情况发生的可能性（概率）做一个估计',
        proposition: '你最终进入X3读书'
      },
      {
        propositionDescription:
          '假设你没有填写提前批次的志愿，请对下列情况发生的可能性（概率）做一个估计',
        proposition: '你最终进入前两所志愿院校（即X3，X1）中的某一所读书',
        hint:
  ...
  },
  {
    ...
    descriptionHighlight:
      '现在，重新考虑你原先填写的志愿。在该问题中，假设你已经知道这些学校的录取分数线分别是多少了。',
    description: '四所学校的分数线如下表中“录取分数线”一栏所示',
    sub_description:
      '根据你的填写，你的高考总分是score分。没有填写提前批次志愿的情况下，请对下列情况发生的可能性（概率）做一个估计。如果你认为某情况肯定会发生，那么请将可能性调整至100%；如果你认为某情况一定不会发生，请将可能性调整至0%',
    questions: [
      {
        propositionDescription:
          '假设你没有填写提前批次的志愿，请对下列情况发生的可能性（概率）做一个估计',
      ...
      },
      {
        propositionDescription:
          '假设你没有填写提前批次的志愿，请对下列情况发生的可能性（概率）做一个估计',
        proposition: '你最终进入志愿表上的任意一所院校（即X1，X2，X3，X4）读书'
      }
    ]
  },
  {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        propositionDescription:
          '假设你没有填写提前批次的志愿，请对下列情况发生的可能性（概率）做一个估计',
        proposition: '你最终进入志愿表上的任意一所院校（即X1，X2，X3）读书'
      }
    ]
  },
  {
