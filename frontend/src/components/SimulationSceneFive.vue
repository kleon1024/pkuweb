<template>
  <div>
    ...
    <section style="margin-top: 50px;" v-if="satisfactions[0]">
      <p>
        小刚现在需要你帮助他填报志愿。
        为了鼓励你认真作答，我们将会根据你的回答，以及今年学校的录取分数线来计算小刚获得的满意度，并以此为据为你发放奖励，奖励额度与满意度相同。
        比如说，如果小刚被{{ satisfactions[0].college.full_name }}录取，那么我们将给你 {{ satisfactions[0].value }}元奖励。
        如果小刚未被任何学校录取，那么你将不能获得任何奖励。
      </p>
      <h4>
