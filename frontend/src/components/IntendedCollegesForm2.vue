<template>
  <div>
    <section>
      <p>根据您填写的信息和我们的算法，您很可能填写了二批次志愿。下面，请您填写您在志愿填报系统中提交的第二批次（非定向）的志愿院校。
        <span class="danger"> 请完整地填写您填报的志愿院校，以免影响问卷报酬的发放。</span></p>
      <FillableZhiyuanForm2 v-model="selectedColleges" />
    </section>
    <section style="margin-top: 20px;">
      <el-divider />
      <div>
        <p>为了更加了解宁夏考生在填报志愿时的想法和困难，我们需要您回答一些与志愿填报有关的问题。 正确的回答越多，您将会获得越多的报酬。</p>
        <p>您的回答有助于我们发现考生对录取规则理解的偏差，为高考的改革提供更多线索。因此，我们希望您在这些题中认真阅读题目，尽力得到准确的答案。</p>
      </div>
