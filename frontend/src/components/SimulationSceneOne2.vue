<template>
  <div>
    ...
    <section style="margin-top: 50px;">
      ...
      <FillableZhiyuanForm v-model="selected2Colleges" :intendeds="intendedColleges2" :choices="2" show-all-colleges />
    </section>
    <section style="margin-top: 50px;">
      <h4>3. 假设你只能在一本志愿表中填写一所院校，B院校，C院校，D院校的位置空着，那么你会如何填写？</h4>
      <FillableZhiyuanForm v-model="selected1Colleges" :intendeds="intendedColleges2" :choices="1" show-all-colleges />
    </section>
