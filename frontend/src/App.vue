...
export default {
  ...
  computed: {
    ...
    content() {
      ...
      if (this.finishAll) {
        r =
          "问卷填写已完成。若你还有其它的问题，请通过微信pku_zhiyuan1联系我们，感谢你的支持与配合！";
      } else {
        r =
          "如果你尚未完成问卷，你的部分回答将无法被记录。如果你想再次登录之前填写的问卷，请重新填写问卷开头的身份信息，网页将自动跳转到你之前填写的地方。你还有其它的问题，请通过微信pku_zhiyuan1联系我们。";
      }
